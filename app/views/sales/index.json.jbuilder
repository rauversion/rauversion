if @dashboard
  json.dashboard @dashboard.except(:recent_sales)
  json.collection @dashboard[:recent_sales]
  ...
  json.metadata do
    ...
    json.next_page nil
    json.prev_page nil
    json.is_first_page true
    json.is_last_page true
    json.total_count @dashboard[:recent_sales].length
    json.tab @tab
  end
else
